...
public class Drugstore {
	...
	public Drugstore(String fecha, String local_id, String local_nombre, String comuna_nombre, String localidad_nombre,
			String local_direccion, String funcionamiento_hora_apertura, String funcionamiento_hora_cierre,
			String local_telefono, String local_lat, String local_lng, String funcionamiento_dia, String fk_region,
			String fk_comuna) {
		super();
		this.fecha = fecha;
